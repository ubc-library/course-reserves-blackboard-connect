 ...
 * modified by skk 5/20/15
 */
//console.log("this is not jof - skk");
...
function initLocr() {
    ...
    t.onload = function () {
        if(!isLoaded){
            ...
            f.setAttribute('method',"post");
            f.setAttribute('id','frameContent');
            f.setAttribute('action',"https://dev-cr.library.ubc.ca/tab.php");
            f.style.width = "100%";
            f.style.border = "none";
            f.style.margin = 0;
            f.style.padding = 0;
...
/* old
 ...
 function initLocr() {
 var e,
 t = document.getElementById("contentFrame"),
 n = document.getElementById("frameContent"),
 ...
 t.style.height = document.getElementById("content").offsetHeight + "px"; // globalNavPageContentArea
 t.style.height = document.getElementById("globalNavPageContentArea").offsetHeight + "px"; // globalNavPageContentArea
 e.getElementById("frameContent").submit();
 }
 window.setTimeout(function () {
 initLocr()
 }, 50);
 ...
 function initLocr() {
 var e, t = document.getElementById("contentFrame"), n = document.getElementById("frameContent"), o = document.getElementById("content");
 o.innerHTML = "", o.appendChild(t), e = t.contentDocument ? t.contentDocument : t.contentWindow.document, e.body.appendChild(n), t.style.height = document.getElementById("content").offsetHeight + "px", e.getElementById("frameContent").submit()
 }
 window.setTimeout(function () {
 initLocr()
 }, 50);
