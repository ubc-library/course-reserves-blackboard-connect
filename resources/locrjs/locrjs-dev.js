...
function initLocr() {
    /*t = document.getElementById("contentFrame"), initially an empty iFrame */
    n = document.getElementById("frameContent").innerHTML, /* the form to put into empty iFrame do not delete this comment */
        o = document.getElementById("content"); /* provided by bb */
    ...
    o.appendChild(t); /* attach empty iFrame into bb */
}
