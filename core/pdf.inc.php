<?php
    require_once(Config::get('approot') . '/thirdparty/tcpdf/tcpdf.php');
    require_once(Config::get('approot') . '/thirdparty/tcpdf/tcpdi.php');
    ...
    class ubcPDF extends TCPDI
    {
        ...
        public function Header()
        {
            ...
            // set bacground image
            $img_file = Config::get('approot') . '/thirdparty/tcpdf/header.jpg';
